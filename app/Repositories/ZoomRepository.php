...
class ZoomRepository
{
    ...
    public function zoomGet($id)
    {
        ...
        try {
            ...
            if ($e->getCode() == 0) {
               ...
               throw new UnprocessableEntityHttpException(__('messages.live_consultation.connect_with_zoom') . ' ' . $e->getMessage());
            }
            throw new UnprocessableEntityHttpException($e->getMessage());
        }
    }
    ...
    public function destroyZoomMeeting($meetingId)
    {
        ...
        try {
            ...
            if ($e->getCode() == 0) {
                throw new UnprocessableEntityHttpException(__('messages.live_consultation.connect_with_zoom') . 'HERE');
            }
            throw new UnprocessableEntityHttpException($e->getMessage());
        }
    }
